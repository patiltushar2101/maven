          ...
          >
            <div className="card-content">
              ...
              <div className="card-contact-wrapper">
                <a href={"https://www.google.co.in/maps/search/" + userDetails.address} target="_blank"><div className="card-contact">
                  <a href={"https://www.google.co.in/maps/search/" + userDetails.address} target="_blank"><svg
